...
import grpc.smartalarms.smartAlarmsGrpc;
import grpc.smartcameras.smartCamerasGrpc;
import grpc.smartsafety.smartSafetyGrpc;
...
public class ControllerGUI implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (label.equals("Invoke Service 1")) {
			...
			smartSafety.RequestMessage request = smartSafety.RequestMessage.newBuilder().setText(entry1.getText()).build();

			//retreving reply from service
			smartSafety.ResponseMessage response = blockingStub.service1Do(request);
